package com.gvk.algoritms;

import com.gvk.algoritms.exceptions.InvalidElementException;
...
public class DoublyLinkedList<E> {
    ...
    public DoublyLinkedList() {
        ...
        dummyHead = new DoublyLinkedListNode<E>(null);
        dummyTail = new DoublyLinkedListNode<E>(null);
